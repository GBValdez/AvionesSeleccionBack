...
namespace AvionesBackNet.Migrations
{
    ...
    [Migration("20240604004748_UserUpdateOptional")]
    partial class UserUpdateOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AvionesBackNet.Models.Cliente", b =>
                {
                    ...
                    b.Property<long>("CodigoTelefonoEmergenciaNavigationId")
                        .HasColumnType("bigint");

                    b.Property<long>("CodigoTelefonoNavigationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CodigoTelefonoEmergenciaNavigationId");
            ...
            modelBuilder.Entity("AvionesBackNet.Models.ModeloAvionAerolinea", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ModeloAvionAerolineas");
                });
            ...
            modelBuilder.Entity("AvionesBackNet.Models.Cliente", b =>
                {
                    b.HasOne("AvionesBackNet.Models.Catalogo", "CodigoTelefonoEmergenciaNavigation")
                        .WithMany()
                        .HasForeignKey("CodigoTelefonoEmergenciaNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AvionesBackNet.Models.Catalogo", "CodigoTelefonoNavigation")
                        .WithMany()
                        .HasForeignKey("CodigoTelefonoNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("CodigoTelefonoEmergenciaNavigation");
            ...
            modelBuilder.Entity("AvionesBackNet.Models.ModeloAvionAerolinea", b =>
                {
                    b.HasOne("AvionesBackNet.Models.Aerolinea", "Aerolinea")
                        .WithMany("ModeloAvionAerolineas")
                        .HasForeignKey("AerolineaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AvionesBackNet.Models.Catalogo", "ModeloAvion")
                        .WithMany()
            ...
            modelBuilder.Entity("AvionesBackNet.Models.Aerolinea", b =>
                {
                    ...
                    b.Navigation("ModeloAvionAerolineas");
